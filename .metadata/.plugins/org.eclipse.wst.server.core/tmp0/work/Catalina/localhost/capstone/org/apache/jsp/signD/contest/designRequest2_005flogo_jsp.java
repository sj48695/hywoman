 ...
 * Generated at: 2019-02-21 14:21:40 UTC
...
public final class designRequest2_005flogo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (id != null && member.getType().equals("의뢰인")) {
      ...
      out.write("\t\t\t<p class=\"lead\"><strong>공모할 로고 디자인의 상세정보를 입력하세요.</strong></p>\r\n");
      ...
      out.write("\t\t\t\t\t<div class=\"progress-bar\" style=\"width: 50%; background-color: tomato;\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</section>\r\n");
      ...
      out.write("\t\t<form method=\"post\" action=\"designRequest3.jsp?category=");
      out.print(category );
      out.write("\" enctype=\"multipart/form-data\">\r\n");
      out.write("\t\t\t<!-- get방식으로 보내면 한글 안깨짐 -->\r\n");
      out.write("\t\t\t<input hidden=\"true\" name=\"category\" value=\"");
      out.print(category);
      out.write("\" >\r\n");
      out.write("\t\t\t<input hidden=\"true\" name=\"plans\">\r\n");
      out.write("\t\t\t<div class=\"mb-4\">\r\n");
      out.write("\t\t\t\t<label class=\"lbr\">1. 제목<font color=\"darksalmon\">＊</font></label> \r\n");
      out.write("\t\t\t\t<input class=\"inp inpp mx-5\" type=\"text\" name=\"title\" placeholder=\"ex) DO 로고 디자인 의뢰\" required>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"mb-4\">\r\n");
      out.write("\t\t\t\t<label class=\"lbr\">2. 회사명<font color=\"darksalmon\">＊</font></label> \r\n");
      out.write("\t\t\t\t<input class=\"inp mx-5\" type=\"text\" name=\"company_name\" placeholder=\"ex) DO(DesignOutsourcing)\" required>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"mb-4\">\r\n");
      out.write("\t\t\t\t<label class=\"lbr\">3. 회사 서비스 설명</label>\r\n");
      out.write("\t\t\t\t<textarea class=\"inparea mx-5\" name=\"service\" rows=\"6\"\r\n");
      out.write("\t\t\t\t\tplaceholder=\"ex) DO는 디자인을 필요로 하는 사람들이 다양한 디자인(로고, 패키지, 웹 디자인 등)에 대한 콘테스트를 개최하고 \r\n");
      out.write("      콘테스트에 참여한 사람들의 디자인을 채택 합니다.\"></textarea>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"mb-3 w3-row\">\r\n");
      out.write("\t\t\t\t<label class=\"lbr\">4. 업종</label>\r\n");
      out.write("\t\t\t\t<div class=\"w3-col s5 pl-5 mr-4\">\r\n");
      out.write("\t\t\t\t\t<div class=\"input_chk\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" id=\"cf\" class=\"ipn\" name=\"job_kind_group\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"식당/카페 \" onchange=\"otherChange('job_kind',this.id)\">\r\n");
      out.write("\t\t\t\t\t\t<label for=\"cf\">식당/카페 </label>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"input_chk\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" id=\"fo\" class=\"ipn\" name=\"job_kind_group\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"식품/건강\" onchange=\"otherChange('job_kind',this.id)\">\r\n");
      out.write("\t\t\t\t\t\t<label for=\"fo\">식품/건강</label>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"input_chk\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" id=\"it\" class=\"ipn\" name=\"job_kind_group\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"IT/미디어\" onchange=\"otherChange('job_kind',this.id)\">\r\n");
      out.write("\t\t\t\t\t\t<label for=\"it\">IT/미디어</label>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"input_chk\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" id=\"bu\" class=\"ipn\" name=\"job_kind_group\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"뷰티/패션\" onchange=\"otherChange('job_kind',this.id)\">\r\n");
      out.write("\t\t\t\t\t\t<label for=\"bu\">뷰티/패션</label>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"input_chk\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" id=\"ho\" class=\"ipn\" name=\"job_kind_group\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"병원\" onchange=\"otherChange('job_kind',this.id)\"> \r\n");
      out.write("\t\t\t\t\t\t<label for=\"ho\">병원</label>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"w3-col s6 ml-5 pr-5\">\r\n");
      out.write("\t\t\t\t\t<div class=\"input_chk\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" id=\"pe\" class=\"ipn\" name=\"job_kind_group\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"애완동물\" onchange=\"otherChange('job_kind',this.id)\">\r\n");
      out.write("\t\t\t\t\t\t<label for=\"pe\">애완동물</label>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"input_chk\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" id=\"ed\" class=\"ipn\" name=\"job_kind_group\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"교육/육아\" onchange=\"otherChange('job_kind',this.id)\">\r\n");
      out.write("\t\t\t\t\t\t<label for=\"ed\">교육/육아</label>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"input_chk\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" id=\"go\" class=\"ipn\" name=\"job_kind_group\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"공공기관\" onchange=\"otherChange('job_kind',this.id)\">\r\n");
      out.write("\t\t\t\t\t\t<label for=\"go\">공공기관</label>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"input_chk w3-row\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" id=\"ot\" class=\"ipn\" name=\"job_kind_group\"\r\n");
      out.write("\t\t\t\t\t\t\tvalue=\"일반/기타\" onchange=\"otherChange('job_kind',this.id)\">\r\n");
      out.write("\t\t\t\t\t\t<label for=\"ot\" class=\"w3-col s4\">일반/기타</label> \r\n");
      out.write("\t\t\t\t\t\t<input class=\"inp w3-col s8 m-0 job_kind_other\" type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\tname=\"job_kind\" placeholder=\"job_kind\" style=\"visibility: hidden;\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"mb-4 w3-row\">\r\n");
      out.write("\t\t\t\t<label class=\"lbr pb-4\">5. 색상<font color=\"darksalmon\">＊</font>\r\n");
      out.write("\t\t\t\t\t<input type=\"checkbox\" id=\"colorchk\" value=\"free\" onclick=\"colorChk()\">\r\n");
      out.write("\t\t\t\t\t<label for=\"colorchk\">색을 정하기 힘드시면 '자유롭게'를 선택해주세요.</label>\r\n");
      out.write("\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t<div class=\"w3-col l4 text-center\" >\r\n");
      out.write("\t\t\t\t\t<div style=\"margin:auto;width:236px;\">\r\n");
      out.write("\t\t\t\t\t\t<img style=\"margin-right:2px;\" src=\"https://www.w3schools.com/colors/img_colormap.gif\" usemap=\"#colormap\" alt=\"colormap\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<script>\r\n");
      out.write("\t\t\t\t\t\t\tvar thistop = \"-35\";\r\n");
      out.write("\t\t\t\t\t\t\tvar thisleft = \"135\";\r\n");
      out.write("\t\t\t\t\t\t</script>\r\n");
      out.write("\t\t\t\t\t\t<div id=\"selectedhexagon\" style=\"visibility: visible; position: relative; width: 21px; height: 21px; background-image: url(&quot;https://www.w3schools.com/colors/img_selectedcolor.gif&quot;); top: -110px; left: 108px;\"></div>\r\n");
      out.write("\t\t\t\t\t    <div id=\"divpreview\" style=\"visibility: hidden; background-color: rgb(255, 0, 0);\">&nbsp;</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"w3-col l8  w3-row\" style=\"text-align:center;\">\r\n");
      out.write("\t\t\t\t\t<div id=\"entercolorDIV\" class=\"input-group w3-col s11 py-3\"><h3 class=\"w3-col s3 mr-3\">color select : </h3>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" class=\"form-control inp\" id=\"entercolor\" placeholder=\"색상을 입력해주세요.\" onkeydown=\"submitOnEnter(event)\" onfocus=\"clearWrongInput();\" style=\"z-index: 0;\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"input-group-append\">\r\n");
      out.write("\t\t\t\t\t\t\t<button class=\"btn btn-default inpb\" type=\"button\" onclick=\"clickColor(0,-1,-1)\" style=\"z-index: 0;\">OK</button>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div id=\"wronginputDIV\" class=\"w3-col s11\" style=\"display: none;\">영어나 RGB코드로 입력해주세요.</div>\r\n");
      out.write("\t\t\t\t\t<br>\r\n");
      out.write("\t\t\t\t\t<div id=\"selectedcolor\" class=\"w3-col s3\">\r\n");
      out.write("\t\t\t\t\t\t<input class=\"form-control btn btn-outline-light\" type=\"color\" id=\"html5colorpicker\" onchange=\"clickColor(0, -1, -1, 5)\" value=\"#ff0000\" style=\"width: 120px;height: 120px;padding: 0;\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div hidden=\"true\" id=\"colornamDIV\" class=\"w3-margin-top\"></div>      \r\n");
      out.write("\t\t\t\t\t<input hidden=\"true\" name=\"color\" id=\"colorhexDIV\" value=\"\">\r\n");
      out.write("\t\t\t\t\t<div hidden=\"true\" id=\"colorrgbDIV\">rgb(255, 0, 0)</div>\r\n");
      out.write("\t\t\t\t\t<div hidden=\"true\" id=\"colorhslDIV\">hsl(260, 100%, 70%)</div>\r\n");
      out.write("\t\t\t\t\t<label class=\"lbr w3-col s8 pt-3\">※원하시는 추상적인 색이 있다면 적어주세요.</label>\r\n");
      out.write("\t\t\t\t\t<input class=\"inp w3-col s8\" type=\"text\" name=\"color_detail\" placeholder=\"자세한 설명을 적어주세요.\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div>\r\n");
      out.write("\t\t\t\t<label class=\"lbr pb-2\">6. 로고사용계획</label>\r\n");
      out.write("\t\t\t\t<div class=\"pl-5\">\r\n");
      out.write("\t\t\t\t\t<div class=\"input_chk\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"checkbox\" id=\"product\" class=\"ipn\" name=\"plan-group\" value=\"상품\" onchange=\"otherChange('plan',this.id)\"> \r\n");
      out.write("\t\t\t\t\t\t<label for=\"product\">상품</label>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"input_chk\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"checkbox\" id=\"business_card\" class=\"ipn\" name=\"plan-group\" value=\"명함\" onchange=\"otherChange('plan',this.id)\"> \r\n");
      out.write("\t\t\t\t\t\t<label for=\"business_card\">명함</label>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"input_chk\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"checkbox\" id=\"sign\" class=\"ipn\" name=\"plan-group\" value=\"간판\" onchange=\"otherChange('plan',this.id)\"> \r\n");
      out.write("\t\t\t\t\t\t<label for=\"sign\">간판</label>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"input_chk w3-row\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"checkbox\" id=\"other\" class=\"ipn\" name=\"plan-group\" value=\"other\" onchange=\"otherChange('plan',this.id)\"> \r\n");
      out.write("\t\t\t\t\t\t<label for=\"other\" class=\"w3-col s2\">일반/기타</label> \r\n");
      out.write("\t\t\t\t\t\t<textarea class=\"w3-col s9 m-0 inparea plan_other ml-4\" rows=\"3\" placeholder=\"Plan\" style=\"visibility: hidden;\" name=\"plan\"></textarea>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"mb-4\">\r\n");
      out.write("\t\t\t\t<label class=\"lbr\">7. 참고파일 </label> <input class=\"inp mx-5\"\r\n");
      out.write("\t\t\t\t\ttype=\"file\" name=\"file\" placeholder=\"File\" style=\"padding: 5px;\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"mb-4\">\r\n");
      out.write("\t\t\t\t<label class=\"lbr\">8. 로고에 표기할 상호명/슬로건<font color=\"darksalmon\">＊</font></label> \r\n");
      out.write("\t\t\t\t<input class=\"inp mx-5\" type=\"text\" name=\"slogan\" required\r\n");
      out.write("\t\t\t\t\tplaceholder=\"ex1) 영문: DO(Design outsourcing) / 한글: 디자인아웃소싱 별도 제작 요청\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"mb-4\">\r\n");
      out.write("\t\t\t\t<label class=\"lbr\">9. 상세적인 디자인 요구사항<font color=\"darksalmon\">＊</font></label>\r\n");
      out.write("\t\t\t\t<textarea class=\"inparea mx-5\" name=\"request\" rows=\"15\" required\r\n");
      out.write("\t\t\t\t\tplaceholder=\"*의미: 디자인아웃소싱의 의미는 DesignOutsourcing의 줄임말과 누구든 할 수 있다는 do를 합친 단어 입니다.\r\n");
      out.write("\r\n");
      out.write("*활용범위: 웹사이트와 모바일웹,어플로 서비스하는 회사입니다.따라서 사이즈가 작은 어플 아이콘으로도 사용될 수 있게 심플하고 가독성이 좋은 로고를 원합니다.\"></textarea>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<p class=\"text-center\">\r\n");
      out.write("\t\t\t\t<button type=\"submit\" class=\"btn btnOr btn-lg\">확인</button>\r\n");
      out.write("\t\t\t</p>\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
