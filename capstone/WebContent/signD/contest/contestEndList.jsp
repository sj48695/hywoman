		...
		<div class="col-lg-4">
			<div class="row justify-content-center">
				...
				<img <%if (rq.getPpcode() > 0) {//채택한 작품이 있다면
					...
					class="col-sm-8 p-0 pointer"
					style=" width:253.33px; height:253.33px; border: 1px solid #f1f1f1;">
				<div class="new_list_sub_top p-0">
					<div class="new_list_cate inline"><%=rq.getCategory()%>&nbsp;|&nbsp;</div>
					<h1 class="new_list_title inline" style="font-size: 14px;"><%=rq.getTitle()%></h1>
				</div>
			</div>
			<hr class="my-3">
