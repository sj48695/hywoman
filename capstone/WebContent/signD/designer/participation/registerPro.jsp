...
<%
	...
	String saveFolder1 = "/fileSave/participationFile/" + category;//파일이 업로드되는 폴더
...
<%
		...
		%>
			...
			<meta http-equiv="Refresh" content="0;url=/capstone/signD/contest/detail.jsp?requestcode=<%=rqcode%>">
	<%
		} else {
	%>
			<script type="text/javascript">
