...
%>		<form method="post" action="portfolioRegisterPro.jsp" class="card-body" enctype="multipart/form-data">	
...
%>
		<form method="post" action="portfolioRegisterPro.jsp?requestcode=<%=rqcode %>" class="card-body" enctype="multipart/form-data">	
			 <%-- <input type="hidden" name="requestcode" value="<%=rqcode%>"> 
			 <input type="hidden" name="category" value="<%=category%>">  --%>
			<div class="form-group row">
