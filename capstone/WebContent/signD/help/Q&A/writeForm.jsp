...
<div class="container">
	<div class="w3-border w3-light-grey w3-row">
		...
		<a href="/capstone/signD/help/Q&A.jsp" class="w3-button w3-col s3 w3-brown">Q&A</a> 
		<a href="/capstone/signD/help/rule.jsp" class="w3-button w3-col s3">이용방법</a>
	</div>
	<div class="py-4 row justify-content-center">
		<div class="card col-sm-10">
   		 	<h4 class="card-title text-center py-4">Q&amp;A 등록</h4>
			<form method="post" action="Q&A/writePro.jsp" class="card-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea class="form-control" name="contents" id="summernote" placeholder="문의사항을 적어주세요" rows="15"></textarea>
					</div>
				</div>
...
<jsp:include page="../../module/bottom.jsp" flush="false" />	<!-- include libraries(jQuery, bootstrap) -->
