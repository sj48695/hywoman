...
<div class="container">
	...
	<div class="py-4 row justify-content-center">
		<div class="card col-sm-10">
   		 	<h4 class="card-title text-center py-4">FAQ 등록</h4>
			<form method="post" action="FAQ/writePro.jsp" class="card-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea class="form-control" name="contents" id="summernote" placeholder="고객님들이 자주하는문의를 적어주세요" rows="15"></textarea>
					</div>
				</div>
