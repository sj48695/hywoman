...
<div class="container">
	...
	<div class="py-4 row justify-content-center">
		<div class="card col-sm-10">
			...
			<form method="post" action="Q&A/updatePro.jsp" class=" card-body">
				<input type="hidden" name="qnacode" value="<%=qna.getQnAcode()%>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea class="form-control" name="contents" id="summernote" placeholder="문의사항에 대한 답변" rows="15"><%=qna.getContents() %></textarea>
					</div>
				</div>
