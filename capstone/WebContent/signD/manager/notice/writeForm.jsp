...
<div class="container">
	...
	<div class="py-4 row justify-content-center">
		<div class="card col-sm-10">
			...
			<form method="post" action="notice/writePro.jsp" class="card-body">
				<input type="hidden" name="ref" value="1">
				<input type="hidden" name="re_step" value="0">
				<div class="form-group row">
					<label class="col-form-label col-sm-1">제목</label>
					<div class="col-sm-6">
						<input class="form-control" type="text" name="title" placeholder="Title" value="[공지사항]">
					</div>
				</div>
				<div class="form-group row">
					<label class="col-form-label col-sm-1">내용</label>
					<div class="col-sm-10">
						<textarea class="form-control" name="contents" id="summernote" placeholder="공지사항을 적어주세요" rows="15"></textarea>
					</div>
				</div>
