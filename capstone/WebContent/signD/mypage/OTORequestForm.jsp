	            ...
	            <td id="selOTO">
	            	<span onClick="tableColor();">
	                  ...
	                  <div id="rq<%=i%>" class="collapse py-3" aria-labelledby="rq<%=i%>" data-parent="#accordion">
	                     <jsp:include page="../contest/requestBriefing.jsp" flush="false">
		...
		%>
			...
			%>
					...
					<%	if (member.getType().equals("디자이너") && answer==null){%>	
							<button  onclick="location.href='/capstone/signD/otorequest/OTOAnswerForm.jsp?requestcode=<%=rq.getRequestcode() %>&category=<%=rq.getCategory() %>'"
					...
					<%	}else if (answer!=null){%>
							...
							<div class="modal fade" id="answer<%=i+1%>" tabindex="-1" role="dialog" aria-hidden="true">
								<jsp:include page="../otorequest/OTOAnswerModal.jsp">
