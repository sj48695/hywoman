...
<div class="container footerbottom">
   <div class="w3-row-padding w3-center w3-margin-top">
      <div class="w3-quarter">
         <a class="w3-button paddingz" href="OTORequest2_logo.jsp?category=logo&designerId=<%=designerId%>">
      ...
      <div class="w3-quarter">
         <a class="w3-button paddingz" href="OTORequest2_package.jsp?category=package&designerId=<%=designerId%>">
            <div class="w3-card w3-container" style="min-height: 460px">
               <br>
               <h3>PACKAGE</h3>
               <p>패키지</p>
      ...
      <div class="w3-quarter">
            <a class="w3-button paddingz" href="OTORequest2_web.jsp?category=web&designerId=<%=designerId%>">
            <div class="w3-card w3-container" style="min-height: 460px">
               <br>
               <h3>WEB</h3>
               <p>웹</p>
      ...
      <div class="w3-quarter">
         <a class="w3-button paddingz" href="OTORequest2_other.jsp?category=other&designerId=<%=designerId%>">
            <div class="w3-card w3-container" style="min-height: 460px">
               <br>
               <h3>OTHER</h3>
               <p>그 외</p>
