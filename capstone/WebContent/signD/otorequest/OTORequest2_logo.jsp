...
<div class="container requestbg footerbottom">
   <div class="content">
      <form method="post" action="OTORequest3.jsp?category=<%=category %>&designerId=<%=designerId%>" enctype="multipart/form-data">
         <!-- get방식으로 보내면 한글 안깨짐 -->
         <input hidden="true" name="category" value="<%=category%>">
         <input hidden="true" name="designerId" value="<%=designerId%>">
			...
			<div class="mb-4 w3-row">
				...
				<div class="w3-col l8  w3-row" style="text-align:center;">
					<div id="entercolorDIV" class="input-group w3-col s11 py-3"><h3 class="w3-col s3 mr-3">color select : </h3>
						<input type="text" class="form-control inp" id="entercolor" placeholder="Color value" onkeydown="submitOnEnter(event)" onfocus="clearWrongInput();" style="z-index: 0;">
					...
					<div id="selectedcolor" class="w3-col s3">
						<input class="form-control btn btn-outline-light" type="color" id="html5colorpicker" onchange="clickColor(0, -1, -1, 5)" value="#ff0000" placeholder="Color value" style="width: 120px;height: 120px;padding: 0;">
					</div>
					...
					<input class="inp w3-col s8" type="text" name="color_detail" placeholder="Color_detail">
				</div>
			</div>
			<div>
				...
				<div class="pl-5">
					<div class="input_chk">
						<input type="checkbox" id="product" class="ipn" name="plan-group"
							value="상품" onchange="otherChange('plan',this.id)"> 
						<label for="product">상품</label>
					</div>
					<div class="input_chk">
						<input type="checkbox" id="business_card" class="ipn" name="plan-group"
							 value="명함" onchange="otherChange('plan',this.id)"> 
						<label for="business_card">명함</label>
					</div>
					<div class="input_chk">
						<input type="checkbox" id="sign" class="ipn" name="plan-group"
							value="간판" onchange="otherChange('plan',this.id)"> 
						<label for="sign">간판</label>
					</div>
					<div class="input_chk w3-row">
						<input type="checkbox" id="other" class="ipn" name="plan-group"
							value="other" onchange="otherChange('plan',this.id)"> 
						<label for="other" class="w3-col s2">일반/기타</label> 
						<textarea class="w3-col s9 m-0 inparea plan_other ml-4" rows="3" name="plan"
							placeholder="Plan" style="visibility: hidden;"></textarea>
					</div>
				</div>
			</div>
			<div class="mb-4">
	         ...
	         <div class="mb-4">
	            ...
	            <input class="inp mx-5" type="text" name="slogan" placeholder="ex1) 영문: DO(Design outsourcing) / 한글: 디자인아웃소싱 별도 제작 요청" required>
	         </div>
	         <div class="mb-4">
